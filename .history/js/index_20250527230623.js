...
const translations = {
  en: {
    ...
    //   phone: "+51 928 193 119",
      ...
      prestamosDesc: "REST API for loan management with Spring Boot and PostgreSQL. Implements Builder and Stream patterns for efficient data operations.",
  ...
  es: {
      ...
      contactTitle: "¡Estar en contacto es fácil!",
        ...
        prestamosDesc: "API para gestión de préstamos con Spring Boot y PostgreSQL. Implementa patrones Builder y Stream para operaciones eficientes.",
        prestamosTech: "Spring Boot · PostgreSQL · JPA · Stream API",
