...
const translations = {
  ...
  es: {
      ...
      contactTitle: "¡Estar en contacto es fácil!",
        ...
        prestamosDesc: "API para gestión de préstamos con Spring Boot y PostgreSQL. Implementa patrones Builder y Stream para operaciones eficientes y construcción de objetos.",
        prestamosTech: "Spring Boot · PostgreSQL · JPA · Stream API",
