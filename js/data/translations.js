export const translations = {
  en: {
    ...
    currentDesc: "Development of full stack web applications using Spring Boot and React. Implementation of RESTful APIs, relational databases, and cloud deployment on AWS/Azure.",
  ...
  es: {
    ...
    currentDesc: "Desarrollo de aplicaciones web full stack utilizando Spring Boot y React. Implementación de APIs RESTful, bases de datos relacionales y despliegue en la nube con AWS/Azure.",
